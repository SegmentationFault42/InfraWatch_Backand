...
export async function webhookRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/systems/webhook/:id/history', webhookController.getIncomingWebhookHistory);
  fastify.get('/systems/webhook/:id/status', webhookController.getWebhookSystemStatus);
}